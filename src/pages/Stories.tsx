    ...
    <Layout>
      ...
      <section className="relative py-20 bg-secondary text-secondary-foreground">
        <div className="container">
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-6">Porter Voices</h1>
          <p className="text-xl text-secondary-foreground/80 max-w-3xl">
            Real stories from the men and women who carry dreams to the summit. Their experiences, challenges, and triumphs inspire us all.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-8">
            {stories.map((story, index) => (
              <Card
                key={story.id}
                className={`overflow-hidden ${index === 0 ? "lg:col-span-2" : ""}`}
              >
                      ...
                      <div className="absolute bottom-4 left-4 text-white">
                        ...
                        <div className="flex items-center gap-3 text-sm text-white/80">
                          {story.years_as_porter && (
                            <span>{story.years_as_porter} years as porter</span>
                          )}
                          {story.mountain && (
